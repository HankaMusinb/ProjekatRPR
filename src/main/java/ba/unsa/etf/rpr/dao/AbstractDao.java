...
public abstract class AbstractDao<T extends Idable> implements Dao<T> {
     ...
     * @throws ArtikliException in case of error with db
     */
    ...
    public T add(T item) throws ArtikliException{
        ...
        try{
            ...
            item.setId(rs.getInt(0)); //set id to return it back */
     ...
     * @return Object
     * @throws ArtikliException in case when object is not found
     */
    public T executeQueryUnique(String query, Object[] params) throws ArtikliException{
        ...
        if (result != null && result.size() == 1){
            ...
            throw new ArtikliException("Object not found");
        }
    }
